...
'HW_3_Best_K_epsilon_Difference_Local_Nightly_N=40,k=5,b=5.pickle',
'HW_3_Best_K_epsilon_Difference_Gloal_Replace_N=40,k=5,b=5.pickle',
'HW_3_Best_K_epsilon_Global_N=100,k=5,b=5.pickle',
'HW_3_Best_K_epsilon_Local_Nightly_N=100,k=5,b=5.pickle',
'HW_3_Best_K_epsilon_Difference_Local_Nightly_N=100,k=5,b=5.pickle',
...
width = 1
opacity = 0.7
attendance_optimal = [4, 5, 5]


reward_names = ['Global', 'Local', 'Local\nDifference', 'Difference\nReplace']
...
##        plt.subplot(311 + i //3)
    ...
    if i < plots_per_graph:
        Title = 'Reward Learning Rate for N=30, k=7, b=4'
